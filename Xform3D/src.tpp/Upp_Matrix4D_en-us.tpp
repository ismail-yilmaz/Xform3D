...
[s2;%% Type defined as [%- Matrix4`_<][%-@(0.0.255) float][%- >].&]
[s3; &]
...
[s3; &]
[s4; &]
[s5;:Upp`:`:Matrix4`_`:`:Ortographic`(const Rect`_`&`,T`,T`): [@(0.0.255) static] 
Matrix4`_<T> [* Ortographic]([@(0.0.255) const] Rect`_<T>[@(0.0.255) `&] 
[*@3 view], T [*@3 fnear], T [*@3 ffar])&]
